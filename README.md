...
This Project is implemented in using three phases of works as described in the assignment and demonstrates backend development engineering, web scraping, ai-based content enhancement, and frontend UIs developmenting it. 


## 📌 Project Overviewings:

The goal of these projects is to develop chattings from articles and  websites and all.

Scraping the oldest blog articles from BeyondChat websites and its sources and all etc.  
...
Scraped the 5 oldest articles from the sites and etc : 
...
Built CRUD APIs using Node.js, Express and Mongoose database. 
...
⚠️ This script is intentionally not deployed and is run manually to avoid serverless execution limits available there. 
...
Reference URLs are still cited at the bottom of the updated articles. 
